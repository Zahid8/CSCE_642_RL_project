...
agent = DDPGAgent(state_dim, action_dim, hidden_dim, lr, gamma, tau, device=device)
...
def save_results():
    with open('ddpg_training_results.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(['Episode', 'Total Reward', 'Goal Reached'])
        writer.writerows(results)
    print("Results saved to ddpg_training_results.csv")
