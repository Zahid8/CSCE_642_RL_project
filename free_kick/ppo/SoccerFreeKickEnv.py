...
class SoccerFreeKickEnv(gym.Env):
    def __init__(self):
        ...
        # Define action space: 0 - Left, 1 - Center, 2 - Right
    ...
    def reset(self):
        ...
        self.ball_speed = 0.0
        self.ball_direction = 1  # 0 - Left, 1 - Center, 2 - Right
    ...
    def get_state(self):
        ...
        normalized_ball_direction = self.ball_direction / 2.0  # 0,1,2 mapped to 0-1
    ...
    def step(self, action):
        ...
        # Action corresponds to direction
        self.ball_direction = action
        ...
        self.ball_velocity = np.array([
            kick_strength * np.sin(angle),
            -kick_strength * np.cos(angle)
        ])
